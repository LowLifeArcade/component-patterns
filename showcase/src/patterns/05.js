...
const ClapIcon = ({ className, styles: userStyles = {} }) => {
...
const ClapCount = ({ className, styles: userStyles = {} }) => {
...
const CountTotal = ({ className, styles: userStyles = {} }) => {
